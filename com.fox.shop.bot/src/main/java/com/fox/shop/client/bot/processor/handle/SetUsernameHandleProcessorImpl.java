...
public class SetUsernameHandleProcessorImpl implements TgCommandProcessorFather {
  private final UserModelDataContext userModelDataContext;
  private final UserCommandStateContext userCommandStateContext;

  public SetUsernameHandleProcessorImpl(
  ...
  public void process(final TgIncomingCommandModel incomingCommand) {
    ...
    userCommandStateContext.setup(incomingCommand.getUserId(), CommandData.GET_PHONE_TITLE);
  }
