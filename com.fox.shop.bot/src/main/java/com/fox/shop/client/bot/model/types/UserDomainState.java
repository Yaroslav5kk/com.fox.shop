...
public enum UserDomainState {
    ...
    SET_NAME(CommandData.GET_USERNAME_TITLE),
    SET_PHONE(CommandData.GET_PHONE_TITLE),
    ...
    SET_ITEM_QUANTITY_ON_UPDATE_TITLE(CommandData.SET_ITEM_QUANTITY_ON_UPDATE_CART_TITLE),
    SET_ITEM_QUANTITY_ON_UPDATE_HANDLE(CommandData.SET_ITEM_QUANTITY_ON_UPDATE_CART_HANDLE),
    ...
    ALL_MAIN_PRODUCT_GROUPS(CommandData.ALL_START_PRODUCT_GROUPS),
